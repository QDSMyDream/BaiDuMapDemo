...
public class JoinCitySidebar extends View {
    ...
    public JoinCitySidebar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JoinCitySidebar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public JoinCitySidebar setOverlayTextView(TextView overlay) {
        this.mOverlayTextView = overlay;
        return this;
    }

    public JoinCitySidebar setOnIndexChangedListener(OnIndexTouchedChangedListener listener) {
