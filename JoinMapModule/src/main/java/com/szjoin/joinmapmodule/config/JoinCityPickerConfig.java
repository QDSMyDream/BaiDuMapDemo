...
/**
 * 创建人：MyDream
 * 创建日期：2021/06/10 10:15
 * 类描述：配置动画、热门城市得显示、自定义内容得显示
 */
public class JoinCityPickerConfig implements Serializable {
     ...
     */
    public JoinCityPickerConfig(boolean showLocation, boolean showHotCities, String strHotCities, String strHotCitiesIcon, boolean useCustomData) {
