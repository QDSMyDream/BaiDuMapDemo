...
public class JoinChineseSortUtil {
    public static void sortList(List<JoinCityBean> list) {
        transferList(list);
    }
     ...
     * @param list
     */
    private static void transferList(List<JoinCityBean> list) {
     ...
     * @param list
     */
    private static void exchangeNameOrder(int j, List<JoinCityBean> list) {
